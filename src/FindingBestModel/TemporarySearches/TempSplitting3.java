...
public class TempSplitting3 {
	...
	public static void main(String[] args) {
		...
		Model originalModel = new ProportionalProbabilityForCharacterModel(data.getTrainingDataSteps(), 2, data.getDataProcessing(), random);
		...
		Model goodModel = new ProportionalProbabilityForCharacterModel(goodValues, 2, data.getDataProcessing(), random);
		ArrayList<DataStep> badValues = DataSplitter.getStepsNotInSplit(data.getTrainingDataSteps(), splitOp);
		Model badModel = new ProportionalProbabilityForCharacterModel(badValues, 3, data.getDataProcessing(), random);
