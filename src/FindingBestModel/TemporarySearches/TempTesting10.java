...
public class TempTesting10 {
    ...
    public static void main(String[] args){
        ...
        String savePath = "Models/TempModel10.txt";
            ...
            for(int a=0;a<layerTypes.length;a++) {
                ...
                for(int b=0;b<hiddenDims.length;b++) {
                    ...
                    for(int i=0;i<attempts;i++) {
                        ...
                        total += (new ModelTrainer("Models/TempLoss10.txt")).train(maximumTrainingEpochs, model, data, displayReportPeriod, showEpochPeriod, checkMinimumPeriod, savePath, random);
                    }
