package FindingBestModel.BestModel.OverallModel;
...
public class FlashcardToSentenceModel {
    ...
    public static String convertFlashcardToSentence(String flashcardFront, String flashcardBack, DataProcessing dataProcessing){
        ...
        double[] outputArray = StackingCombiningModel.execute(inputArray,inputText, dataProcessing);
